...
import 'package:luoda_flutter/plugin/event.dart';
    ...
    switch (url) {
      case kUrlActionClose:
        ...
        Future.microtask(() async {
          // Stop Rust service first, then close UI
          try {
            await bind.mainStopService();
            debugPrint("mainStopService called");
          } catch (e) {
            debugPrint("Error calling mainStopService: $e");
          }
