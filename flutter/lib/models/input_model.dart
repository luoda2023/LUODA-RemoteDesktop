...
class InputModel {
  ...
  // Uses Unicode-aware case detection to support non-ASCII letters (e.g., 眉/脺, 茅/脡).
  //
  // Limitations:
  ...
  //    may not match expectations. For example, ';' on EN layout maps to '枚' on DE
  ...
  void onPointHoverImage(PointerHoverEvent e) {
    ...
    // May fix https://github.com/luoda/luoda/issues/13009
  ...
  static Point<double>? getPointInRemoteRect(
    ...
    // https://github.com/luoda/luoda/issues/6678
