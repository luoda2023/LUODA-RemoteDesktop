...
class LuodaImpl implements Luoda {
  final LuodaPlatform _platform;
  factory LuodaImpl(ExternalLibrary dylib) =>
      LuodaImpl.raw(LuodaPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory LuodaImpl.wasm(FutureOr<WasmModule> module) =>
      LuodaImpl(module as ExternalLibrary);
  LuodaImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
...
argNames: ["key", "value"],
  ...
  FlutterRustBridgeTaskConstMeta get kGetSettingsTabConfigConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "get_settings_tab_config",
        argNames: [],
      );
...
class LuodaPlatform extends FlutterRustBridgeBase<LuodaWire> {
  LuodaPlatform(ffi.DynamicLibrary dylib) : super(LuodaWire(dylib));
...
class LuodaWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  LuodaWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LuodaWire.fromLookup(
...
.asFunction<WireSyncReturn Function(ffi.Pointer<wire_uint_8_list>, ffi.Pointer<wire_uint_8_list>)>();
  ...
  bool luoda_core_main() {
    return _luoda_core_main();
  }

  late final _luoda_core_mainPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function()>>('luoda_core_main');
  late final _luoda_core_main =
      _luoda_core_mainPtr.asFunction<bool Function()>();
  ...
  ffi.Pointer<ffi.Pointer<ffi.Char>> luoda_core_main_args(
    ffi.Pointer<ffi.Int> args_len,
  ) {
    return _luoda_core_main_args(
      args_len,
    );
  }

  late final _luoda_core_main_argsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Pointer<ffi.Char>> Function(
              ffi.Pointer<ffi.Int>)>>('luoda_core_main_args');
  late final _luoda_core_main_args = _luoda_core_main_argsPtr.asFunction<
  ...
  int get_luoda_app_name(
    ffi.Pointer<ffi.Uint16> buffer,
    int length,
  ) {
    return _get_luoda_app_name(
      buffer,
      length,
    );
  }

  late final _get_luoda_app_namePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Uint16>, ffi.Int32)>>('get_luoda_app_name');
  late final _get_luoda_app_name = _get_luoda_app_namePtr
...
const int ERR_LUODA_HANDLE_BASE = 10000;
