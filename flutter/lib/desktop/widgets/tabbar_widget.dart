...
import 'package:luoda_flutter/desktop/pages/view_camera_page.dart';
...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (luodaWinManager.getActiveWindows().contains(kMainWindowId)) {
        await luodaWinManager.unregisterActiveWindow(kMainWindowId);
      }
