...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("LDESK".encode(encoding=encoding))
...
if __name__ == '__main__':
    ...
    # Build is handled by the CI workflow separately.
    # Remove the auto-build here to avoid double-build confusion.
