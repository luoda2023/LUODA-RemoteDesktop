...
// Raised from 0.67 to 0.8: on direct/LAN connections the Balanced preset no
// longer keeps the picture deliberately soft; the QoS layer still ramps it up
// and down based on measured delay.
pub const BR_BALANCED: f32 = 0.8;
