...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("cn.dicad".to_owned());
}
...
pub const LINK_DOCS_HOME: &str = "https://luoda.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://luoda.com/docs/en/manual/linux/#x11-required";
